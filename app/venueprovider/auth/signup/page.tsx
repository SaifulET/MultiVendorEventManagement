...
const SignupPage: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-tr from-[#3A0101] via-[#C94B4B] via-[#8D1414] via-[#C94B4B] to-[#461b1b] min-h-screen w-full flex items-center justify-center px-[24px] py-[17px] md:px-[47px] md:py-[0]">
        ...
        <div className="w-full lg:w-auto lg:min-w-[420px] xl:min-w-[480px] p-[16px] md:p-[24px] md:py-0">
          <div className="">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-center text-sm md:text-base mb-[22px]">
                ...
                <label htmlFor="agree" className="ml-2 text-white cursor-pointer">
                  ...
                  <a
                    href="/terms"
                    className="text-[#610805] hover:text-white/80 transition-colors"
                  >
                    Terms of Service
                  </a>{" "}
                  and{" "}
                  <a
                    href="/privacy"
                    className=" text-[#612e2c] hover:text-white/80 transition-colors"
                  >
                    Privacy Policy
                  </a>
                </label>
            ...
            <div className="mt-6 text-center text-white text-sm md:text-base">
              ...
              <Link href="/venueprovider/auth/signin" className="font-semibold hover:underline">
                Log In
              </Link>
            </div>
