...
const ForgotPasswordPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Send verification code logic would go here
    console.log("Sending verification code to:", email);
    
    // Show success message
    setIsSubmitted(true);
    
    // In a real app, you would navigate to verification page or show success message
            ...
            {isSubmitted ? (
              <div className="text-center py-8">
                ...
                <button
                  ...
                  className="w-full py-3 md:py-3.5 bg-[#8a0808] hover:bg-[#660202] text-white rounded-xl font-semibold text-base md:text-lg transition-all duration-300 hover:shadow-xl"
                >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="text-center text-white text-sm md:text-base">
                  ...
                  <a 
                    href="/login" 
                    className="font-semibold hover:underline hover:text-white/80 transition-colors"
                    onClick={(e) => {
                      e.preventDefault();
                      router.push("/login");
                    }}
