    ...
    {isEditing ? (
      <div className="flex gap-[28px]">
        ...
        <button
          ...
          className="px-[24px] py-[16px] bg-[#B74140] text-white rounded-lg font-medium hover:bg-[#812321] transition-all shadow-lg flex items-center gap-2"
        >
  ...
  <div className="px-8">
    <div className="relative -top-16 mb-8">
      <div className="relative group/avatar">
        <div className="w-32 h-32 rounded-full border-4 border-white bg-gradient-to-br from-amber-400 to-orange-500 shadow-2xl overflow-hidden">
          <img 
            src={profilePhoto}
            alt="Profile" 
