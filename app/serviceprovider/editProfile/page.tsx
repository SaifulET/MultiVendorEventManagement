  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-end gap-3">
          <button
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-6">
            ...
            <div className="flex-1 space-y-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg font-semibold hover:from-red-600 hover:to-red-700 transition-all duration-300 shadow-md hover:shadow-lg"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 text-red-600 hover:bg-red-50 rounded-lg font-semibold transition-all duration-200"
              >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
          <h2 className="text-xl font-bold text-slate-900 mb-6">Profile Information & Account Settings</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 text-slate-900"
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-5 rounded-xl bg-gray-50 border border-gray-200">
              ...
              <button 
                ...
                className="px-5 py-2 text-red-600 hover:text-red-700 font-semibold hover:bg-red-50 rounded-lg transition-all duration-200"
              >
                Change Password
              </button>
            </div>
                  ...
                  {!showDeleteConfirm ? (
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className="px-5 py-2 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 transition-all duration-200"
                      >
                        Confirm Delete
                      </button>
                      <button
