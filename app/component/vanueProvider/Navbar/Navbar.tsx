...
export default function Navbar({ collapsed, toggleSidebar }: NavbarProps) {
  ...
  const roleLabel = formatRoleLabel(user?.role ?? "venue_provider");
  ...
  const handleAddVenue = () => {
    router.push("/venueprovider/addVenue");
  };
