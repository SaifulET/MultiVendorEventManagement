    ...
    return Array.from({ length: 5 }, (_, index) => {
      ...
      return (
        ...
        >
          {isHalf ? (
            <defs>
              <linearGradient id={`planner-finder-half-${serviceProvider.id}-${index}`}>
          ...
          <path
            fill={isFilled ? '#FFC107' : isHalf ? `url(#planner-finder-half-${serviceProvider.id}-${index})` : '#E0E0E0'}
    ...
    <div className="group overflow-hidden rounded-lg border border-[#E5E7EB] bg-white transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-center justify-between border-t border-gray-100 pt-3">
          ...
          <button
            onClick={() => { router.push(`/pages/findEventPlanners/${serviceProvider.id}`); }}
