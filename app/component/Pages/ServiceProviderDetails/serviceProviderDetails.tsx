...
const WeddingPlannerProfile: React.FC = () => {
  ...
  const calendarDays: Array<{ day: number; status: 'available' | 'booked'; dayName: string }> = [
    ...
    <div className="min-h-screen">
      ...
      <div className="px-[32px] md:px-[168px]">
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 md:gap-6">
                ...
                <div className="flex-1">
                  <h1 className="font-inter font-bold text-[18px] md:text-[24px] leading-[32px] tracking-normal  text-gray-900">Marvin McKinney</h1>
                  <p className="text-gray-600 mt-1">Premium Wedding & Event Planner</p>
                  
                  <div className="flex items-center gap-2 mt-2 text-gray-500">
                    <MapPin className="w-4 h-4" />
                    <span className="text-sm">New York, NY & Tri-State Area</span>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:flex-shrink-0">
                ...
                <button className="px-6 py-3 bg-[#B74140] text-white rounded-lg hover:bg-[#963533] transition-colors">
                  Book Now
                </button>
              </div>
            </div>
        ...
        <div>
            ...
            <div className="mt-[48px] flex items-center gap-[16px]">
              ...
              <div className="flex flex-col">
                <span className="font-inter font-normal text-[14px] leading-[20px] tracking-normal text-gray-600">Starting from</span>
                <span className="font-inter font-semibold text-[18px] leading-[28px] tracking-normal text-gray-900">$500/ hour</span>
        ...
        <div className="mt-8 bg-white rounded-lg  border border-[#E5E7EB] p-6 md:p-8">
          <h2 className="font-inter font-semibold text-[20px] leading-[1] tracking-normal text-gray-900 mb-4">About my Services</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            With over 10 years of experience in luxury event planning, I specialize in creating unforgettable weddings and corporate events. My attention to detail and personalized approach ensures every celebration is perfectly tailored to your vision.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">500+ Events Planned</h3>
        ...
        {/* Portfolio */}
        <div className="mt-8 bg-white rounded-lg  border border-[#E5E7EB] p-6 md:p-8">
          <h2 className="font-inter font-semibold text-[20px] leading-[1] tracking-normal text-gray-900 mb-6">Portfolio</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {portfolioImages.map((img, idx) => (
              <div key={idx} className="aspect-square rounded-lg overflow-hidden hover:opacity-90 transition-opacity cursor-pointer">
                <img 
                  src={img}
                  alt={`Portfolio ${idx + 1}`}
                  className="w-full h-full object-cover"
...
<div className="mt-8 bg-white rounded-lg border border-[#E5E7EB] p-6 md:p-8">
  <h2 className="font-inter font-semibold text-[20px] leading-[1] tracking-normal text-gray-900 mb-6">Availability Calendar</h2>
    ...
    <div className="flex items-center gap-2">
      ...
      <span className="text-gray-600">Booked</span>
        ...
        <div className="mt-8 mb-12 bg-white rounded-lg  border border-[#E5E7EB] p-6 md:p-8">
          <h2 className="font-inter font-semibold text-[20px] leading-[1] tracking-normal text-gray-900 mb-6">Reviews & Ratings</h2>
