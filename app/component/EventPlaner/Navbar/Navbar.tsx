...
export default function Navbar({ collapsed, toggleSidebar }: NavbarProps) {
  ...
  const roleLabel = formatRoleLabel(user?.role ?? "event_planner");
  ...
  const notifications: Notification[] = [
    {
      ...
      buttonLink: '/eventPlanner/bookingRequest/123',
    },
    {
      id: 2,
      type: 'message',
      ...
      buttonLink: '/eventPlanner/bookingRequest/456',
    },
    {
      id: 3,
      type: 'confirmed',
      ...
      buttonLink: '/eventPlanner/bookingRequest/789',
    },
    {
      id: 4,
      type: 'venue',
      ...
      buttonLink: '/eventPlanner/bookingRequest/23',
    },
    {
      id: 5,
      type: 'cancelled',
      ...
      time: '3 days ago',
      buttonText: 'View Details',
      buttonLink: '/eventPlanner/bookingRequest/12',
    },
    {
      id: 6,
      type: 'reminder',
  ...
  const handleViewAllNotifications = () => {
    router.push('/eventPlanner/bookingRequest/4');
    setShowNotifications(false);
  };
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <NotificationBell
            ...
            viewAllPath="/eventPlanner/dashboard/notification"
          />
