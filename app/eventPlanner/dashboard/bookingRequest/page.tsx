...
import {
  ...
  fetchEventPlannerBookings,
  fetchEventPlannerBookingStats,
  formatBookingDate,
  formatBookingTime,
  getBookingStatus,
  ...
  type EventPlannerBookingMeta,
  type EventPlannerBookingStats,
...
const mapBooking = (booking: EventPlannerBooking): Booking => ({
  client: {
  ...
  venue: {
    name: getPlannerName(booking),
    type: getPlannerType(booking),
  },
});

export default function BookingRequest() {
  const [bookings, setBookings] = useState<Booking[]>([]);
  const [stats, setStats] = useState<EventPlannerBookingStats>({
    accepted: 0,
    pending: 0,
    rejected: 0,
    totalRequests: 0,
  });
  const [meta, setMeta] = useState<EventPlannerBookingMeta | null>(null);
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => router.push("/eventPlanner/bookingRequest/" + booking.id)}
          ...
          <div className="px-6 py-4 border-t border-gray-100">
            <div className="flex items-center justify-between">
              <p className="text-sm text-[#B74140] font-medium">
                SHOWING {bookings.length ? startIndex : 0}-{bookings.length ? endIndex : 0}{" "}
                OF {meta?.total ?? 0}
              </p>
