...
const generateSampleBookings = (count: number): Booking[] => {
  const names = [
    ...
    {
      name: "Maria Garcia",
      email: "maria.g@events.co",
      avatar: "https://i.pravatar.cc/150?img=10",
    },
    {
      name: "Robert Brown",
      email: "robert.b@business.com",
      avatar: "https://i.pravatar.cc/150?img=14",
    },
    {
      name: "Jennifer Lee",
      email: "jennifer.l@company.io",
      avatar: "https://i.pravatar.cc/150?img=24",
    },
    {
      name: "William Davis",
      email: "william.d@startup.co",
...
const BookingRequest: React.FC<VenueDashboardProps> = ({
  ...
  const [bookings, setBookings] = useState<Booking[]>(
    initialBookings || generateSampleBookings(250)
  );
          ...
          <div className="px-6 py-4 border-t border-gray-100">
            <div className="flex items-center justify-between">
              <p className="text-sm text-[#B74140] font-medium">
                SHOWING {startIndex + 1}-{Math.min(endIndex, bookings.length)}{" "}
                OF {bookings.length}
              </p>
