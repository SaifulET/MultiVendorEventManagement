...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit=async(e: React.FormEvent<HTMLFormElement>)=>{
    e.preventDefault();
    router.push("/eventPlanner/auth/welcomeserviceprovider");
  }
          ...
          <div className="  ">
            ...
            <form className="" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between text-sm md:text-base mb-[22px]">
                ...
                <a href="/eventPlanner/auth/forgetpassword" className="text-white hover:text-white/80 transition-colors">
                  Forgot Password?
                </a>
              </div>
            ...
            <div className="mt-6 text-center text-white text-sm md:text-base">
              ...
              <a href="/eventPlanner/auth/signup" className="font-semibold hover:underline">
                Create New Account
              </a>
            </div>
