...
const ProfilePage: React.FC = () => {
    ...
    {isEditing ? (
      <div className="flex gap-[28px]">
        <button
          ...
          className="px-[24px] py-[16px] bg-white text-slate-700 rounded-lg font-medium hover:bg-slate-100 transition-all shadow-xl"
        >
          Cancel
        </button>
        <button
          onClick={handleSaveChanges}
          className="px-[24px] py-[16px] bg-[#B74140] text-white rounded-lg font-medium hover:bg-[#812321] transition-all  flex items-center gap-2"
        >
      ...
      <button
        ...
        className="px-[24px] py-[16px] bg-[#B74140] text-white rounded-lg font-medium hover:bg-[#B74140] transition-all "
      >
        Edit profile
      </button>
    )}
  ...
  <div className="relative rounded-lg overflow-hidden">
    ...
    {isEditing && (
      <label className="absolute top-4 right-4 cursor-pointer bg-white/80 backdrop-blur-sm p-3 rounded-full shadow-lg hover:bg-white transition-all duration-300 z-20">
        <input 
          type="file" 
          accept="image/*" 
  ...
  <div className="px-8">
    <div className="relative -top-16 mb-8">
      <div className="relative group/avatar">
        <div className="w-32 h-32 rounded-full border-4 border-white bg-gradient-to-br from-amber-400 to-orange-500  overflow-hidden">
          <img 
            src={profilePhoto}
            alt="Profile" 
        ...
        {isEditing && (
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-6 border border-slate-200">
            ...
            <div className="space-y-3">
              {cards.map(card => (
                <div key={card.id} className="flex items-center justify-between p-4 border border-slate-200 rounded-lg hover:border-slate-300 transition-all">
        ...
        {isEditing && (
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
            ...
            <div className="space-y-4">
              {/* Change Password */}
              <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg hover:border-slate-300 transition-all">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all outline-none"
