      ...
      <div className="w-full max-w-[672px] bg-white shadow-[0px_25px_50px_rgba(0,0,0,0.25)] rounded-2xl p-6 md:p-12 relative">
        ...
        <div className="flex flex-col gap-6 md:gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Secondary Button */}
            <button onClick={()=>{router.push("/home/dashboard/dashboard")}} className="w-full h-12 md:h-14 bg-[#B74241] hover:bg-[#912321] transition-colors border border-[#E5E7EB] rounded-xl flex items-center justify-center gap-3">
